...
def run(cve, conf, lp_filter, no_check, download_data):
    no_check = False

    return scan(cve, conf, no_check, lp_filter, download_data)


def scan(cve, conf, no_check, lp_filter, download_data, savedir=None):
